      ...
      <div className="row">
        ...
        <div className="col-lg-6 col-md-6 col-sm-6 col-xs-12">
          ...
          <p>
            ...
            techonlogies and I like to learn new stuffs. I also like to develop
            personal projects and work with others to create awesome things.
            I've developed Web Sites and Web Applications since 2009, among this
            time I have done Back-end and Front-end development. For Back-End I
            have used Java and .NET technologies; for Front-End I have used
            HTML5, CSS3, JavaScript as well as some Frameworks such as{' '}
            <a
            ...
            and some others talking about JavaScript and about CSS I have used{' '}
            <a
          ...
          <p>
            ...
            Developers and some others for UX experts. If you want to invite me
            to start a new project, create cool new things or just say hello
            feel free to contact me, would be a pleasure to know you and share
            knowlegde, experiences or{' '}
            <a
              href="http://www.google.com/recaptcha/mailhide/d?k=0152f29lHGrwdU1YxqHXkPUw==&amp;c=oMh6trvPt7mSACi301fq12NOrESBmpfLVdFnxwSzkWE="
              title="Reveal this e-mail address"
            >
